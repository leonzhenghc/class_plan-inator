  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-6">
      ...
      <div
        ...
        tabIndex={-1}
        className={cn(
          'relative flex max-h-[88vh] w-full max-w-[520px] flex-col overflow-hidden rounded-2xl bg-white shadow-2xl focus:outline-none',
          className,
        )}
      >
        <div className="px-7 pt-5 pb-5">
          ...
          <h2 className="mt-3 text-2xl font-extrabold tracking-tight text-gray-900">{title}</h2>
          {description ? <p className="mt-1 text-[15px] text-gray-500">{description}</p> : null}
        </div>
...
export const inputClass =
  'h-12 w-full rounded-xl border border-gray-200 px-4 text-[15px] text-gray-800 focus:border-brand-500 focus:ring-2 focus:ring-brand-100 focus:outline-none'
